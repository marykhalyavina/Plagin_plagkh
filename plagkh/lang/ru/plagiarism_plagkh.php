...
$string['clreportgenspeed'] = 'Как генерировать отчет?';
$string['clgenereportimmediately'] = 'Создавайте отчеты немедленно';
$string['clgenereportonduedate'] = 'Формировать отчеты в определенное время';
...
$string['clreportpagetitle'] = 'plagkh отчет';
